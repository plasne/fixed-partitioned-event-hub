...
internal class Config : IConfig, IEventHubFixedPartitionProcessorConfig
{
    ...
    public Config(IConfiguration config)
    {
        ...
        this.INBOUND_EVENTHUB_MAX_BATCH_SIZE = Math.Clamp(config.GetValue<int>("INBOUND_EVENTHUB_MAX_BATCH_SIZE"), 1, 1000);
        this.ASSIGN_TO_X_PARTITIONS = Math.Clamp(config.GetValue<int>("ASSIGN_TO_X_PARTITIONS"), 1, 32);
